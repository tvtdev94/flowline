...
const CreateTaskModal: React.FC<CreateTaskModalProps> = ({ userId, isOpen, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-0 md:p-4">
      <div className="bg-white dark:bg-gray-800 rounded-none md:rounded-lg shadow-xl w-full h-full md:h-auto md:max-w-md md:max-h-[90vh] overflow-y-auto">
        <div className="flex items-center justify-between border-b dark:border-gray-700 px-4 md:px-6 py-4">
          <h2 className="text-xl font-semibold dark:text-gray-100">Create New Task</h2>
          <button
            onClick={onClose}
