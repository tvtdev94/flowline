        ...
        <div className="space-y-4">
          ...
          <div className="space-y-3">
            <div className="flex items-start gap-3 p-3 bg-green-50 dark:bg-green-900/20 rounded-lg">
              <div className="flex-shrink-0 w-8 h-8 bg-green-600 text-white rounded-lg flex items-center justify-center">
                ▶
              </div>
              <div>
                <p className="font-medium text-gray-900 dark:text-gray-100">Start Timer</p>
            ...
            <div className="flex items-start gap-3 p-3 bg-red-50 dark:bg-red-900/20 rounded-lg">
              ...
              <div>
                <p className="font-medium text-gray-900 dark:text-gray-100">Stop Timer</p>
                <p className="text-sm text-gray-600 dark:text-gray-400 mt-1">
            ...
            <div className="flex items-start gap-3 p-3 bg-blue-50 dark:bg-blue-900/20 rounded-lg">
              ...
              <div>
                <p className="font-medium text-gray-900 dark:text-gray-100">Drag to Adjust</p>
                <p className="text-sm text-gray-600 dark:text-gray-400 mt-1">
